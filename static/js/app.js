function buildMetadata(sample) {
  ...
  // figure out the person's wash frequency from the data
  var level = data.WFREQ;

  // turn the wash data into an angle using trigonometry.....there's probably an easier way to do this
  ...
  var data = [{ type: 'scatter',
    ...
    marker: {colors:['rgba(24, 213, 76, .5)','rgba(14, 127, 0, .5)', 'rgba(110, 154, 22, .5)',
                           ...
                           'rgba(210, 206, 145, .5)', 'rgba(220, 186, 10, 0.5)',
                           'rgba(220, 174, 10, 0.92)','rgba(220, 92, 10, 0.6)', 'rgba(1, 24, 10, 0.99)',]},
  ...
  var layout = {
    ...
    title: 'How often does this person bathe?',
